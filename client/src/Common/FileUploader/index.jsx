...
export default class FileUploader extends BaseComponent {
  ...
  renderVideo(video) {
    return (
      <div className="list-attachment" key={video.id}>
        <div className="attachment-border">
          <div className="attachment-item">
            <video controls preload="auto" width="150" height="130"
              poster={video.thumb_url}>
              <source src={video.url}
                type={video.attachment_content_type}>
              </source>
            </video>
            <div className="uploaded-file">
              <Chip
  ...
  render() {
    ...
    let disableUpload = this.state.processing ||
      uploadedFiles.length >= MAX_NUMBER_UPLOAD_FILE;
    return (
      <div className="row file-uploader">
        <div className="upload-component">
          <RaisedButton
            ...
            label={this.state.processing ?
              t('attachment.btn_uploading') : t('attachment.btn_choose_file')}
